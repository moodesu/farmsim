...
## v11 — PDA map correction
- Replaced the mission-field polygon overlay with the in-game PDA farmland/parcel numbering.
- The Fields tab now uses the Moss Valley overview plus `infoLayer_farmlands` boundaries and labels, matching the numbering visible in-game.
- This avoids conflating mission field IDs with PDA parcel IDs.
